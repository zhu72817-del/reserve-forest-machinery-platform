...
ITEMS = [
    ("I-FE-001", "风力灭火机 XG25-F", "内采商城", "森林防火装备", "集团统筹", "中国林业物资有限公司", "2000元/台", "用于森林火灾初期扑救、林区巡护保障和应急处置。", "上架", "XG25-F", "4冲程发动机；排量79.9cm3；功率3.2kW；最大风量2025m3/h；最大风速105m/s；有效灭火距离1.85m。", "森林防火、巡护保障、应急处置", "宣传册防火设备"),
    ("I-FE-002", "便携式灭火水泵 XGB2-80M", "内采商城", "森林防火装备", "集团统筹", "中国林业物资有限公司", "2800元/台", "便携式林区取水、供水和初期火情处置水泵。", "上架", "XGB2-80M", "单缸四冲程风冷汽油机；最大扬程80m；重量15kg；功率1.6kW；射程22m；最大压力0.8MPa；最大流量3L/s。", "森林防火、巡护保障、应急处置", "宣传册防火设备"),
    ("I-FE-003", "背负式森林消防水泵 XGB8-170M", "内采商城", "森林防火装备", "集团统筹", "中国林业物资有限公司", "10000元/台", "适合山地林区背负携行、远距离取水和接力灭火。", "上架", "XGB8-170M", "离心式水泵；最大扬程170m；重量14.5kg；最大流量5.8L/s；入口2英寸；出口1.5英寸；最大射程30m。", "森林防火、巡护保障、应急处置", "宣传册防火设备"),
    ("I-FE-004", "智能型森林消防高压接力水泵 XGB12-260M", "内采商城", "森林防火装备", "集团统筹", "中国林业物资有限公司", "11500元/台", "适用于高压接力供水、山地远距离灭火和连续作业。", "上架", "XGB12-260M", "13.5HP；吸水深度7m；最大压力2.60MPa；射程35.1m；排量150cc；最大扬程260m；最大流量321L/min。", "森林防火、巡护保障、应急处置", "宣传册防火设备"),
    ("I-FE-005", "手抬式大流量消防水泵 XGB20-270M", "内采商城", "森林防火装备", "集团统筹", "中国林业物资有限公司", "18000元/台", "用于林区大流量供水、火场接力供水和应急灭火。", "上架", "XGB20-270M", "四冲程水冷汽油机；功率20hp；四级离心泵；电启动；最大扬程260m；最大流量350L/min；最大射程35m。", "森林防火、巡护保障、应急处置", "宣传册防火设备"),
    ("I-FE-006", "远程高压消防水泵 XGB23-350M", "内采商城", "森林防火装备", "集团统筹", "中国林业物资有限公司", "28000元/台", "适合远程高压供水和复杂水质环境下的森林火灾处置。", "上架", "XGB23-350M", "发动机功率23hp；最大流量440L/min；手拉/电启动；四级离心泵；双缸风冷；具备机械式和手动引水。", "森林防火、巡护保障、应急处置", "宣传册防火设备"),
    ("I-FE-007", "远程高压消防水泵 XGB35-420M", "内采商城", "森林防火装备", "集团统筹", "中国林业物资有限公司", "38000元/台", "用于高扬程、高压力远程供水和串并联架设作业。", "上架", "XGB35-420M", "最大流量442L/min；最大压力4.2MPa；最大扬程420m；最大射程42m；整机净质量110kg；进水口50mm、出水口40mm。", "森林防火、巡护保障、应急处置", "宣传册防火设备"),
    ("I-FE-008", "油锯 XGJ-66", "内采商城", "森林防火装备", "集团统筹", "中国林业物资有限公司", "2000元/台", "用于林木采伐、枝干切割、防火隔离带清理和应急清障。", "上架", "XGJ-66", "排量>90.0cm3；常温启动<=6s；锯切效率>=110cm2/s；净重量<=7.5kg；满负荷噪音<105dB(A)。", "森林防火、巡护保障、应急处置", "宣传册防火设备"),
    ("I-FE-009", "防火服 XGF01 普通款", "内采商城", "森林防火装备", "集团统筹", "中国林业物资有限公司", "650元/套", "用于森林防火巡护、扑救和应急处置人员防护。", "上架", "XGF01", "符合GB/T33536-2017；永久阻燃高强度芳纶纤维面料；洗涤50次后续燃时间<=0s；单位面积质量<=208g/m2。", "森林防火、巡护保障、应急处置", "宣传册防火设备"),
    ...
    ("I-VH-008", "2吨座驾履带运输车", "内采商城", "车辆装备", "集团统筹", "中国林业物资有限公司", "16000元/台", "座驾式履带运输车，适用于林区物资、设备和短途运输。", "上架", "2吨座驾履带运输车", "整车尺寸2700*1300*1450mm；车厢尺寸1600*1200*500mm；全柴18马力单缸水冷；底盘宽度1000mm；接地长度1400mm；自重864kg；履带规格230*72*58。", "林区物资运输、山地短驳、装备转运", "新增内采车辆装备"),
    ("I-VH-009", "2吨手扶履带运输车", "内采商城", "车辆装备", "集团统筹", "中国林业物资有限公司", "15000元/台", "手扶式履带运输车，适用于林区狭窄道路和山地短途运输。", "上架", "2吨手扶", "整车尺寸2500*1300*1350mm；车厢尺寸1600*1200*500mm；常柴集团195FA风冷柴油机；功率12.5Ps；底盘宽度1000mm；接地长度1330mm；自重682kg；履带规格230*72*56。", "林区物资运输、山地短驳、装备转运", "新增内采车辆装备"),
...
PRODUCT_IMAGES = {
    ...
    "I-VH-008": "assets/products/I-VH-008.jpg",
    "I-VH-009": "assets/products/I-VH-009.jpg",
